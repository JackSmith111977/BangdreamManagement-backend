...
public class Student {
    ...
    public Student(Integer id, String name, String no, Integer gender, String phone, String idCard, Integer isCollege, String address, Integer degree, LocalDate graduationDate, Integer clazzId, Short violationCount, Short violationScore, LocalDateTime createTime, LocalDateTime updateTime) {
        this.id = id;
        this.name = name;
        this.no = no;
        this.gender = gender;
    ...
    public Student(String name, String no, Integer gender, String phone, Integer degree, Integer clazzId, String idCard, Integer isCollege, String address, LocalDate graduationDate) {
        this.name = name;
        this.no = no;
        this.gender = gender;
        this.phone = phone;
